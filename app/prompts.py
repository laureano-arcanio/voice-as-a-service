...
def build_system_prompt(questions, agent_name, company, client=None, inbound=True):
    ...
    return (
        ...
        "- No arranques dos turnos seguidos con la misma muletilla (entendido, perfecto, buenísimo): "
        "variá o entrá directo a la pregunta. Decí el nombre del interesado solo al saludar y al "
        "despedirte, no en cada turno.\n"
