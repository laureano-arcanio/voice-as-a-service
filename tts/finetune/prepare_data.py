# coding=utf-8
# Origen: QwenLM/Qwen3-TTS finetuning/prepare_data.py via zhyuan11/Qwen3-TTS-Finetuning (agrega --batch_size).
...
def main():
    ...
    parser.add_argument("--tokenizer_model_path", type=str, default=None, help="default: speech_tokenizer/ de Qwen3-TTS-12Hz-1.7B-Base en el HF cache")
    ...
    if args.tokenizer_model_path is None:
        ...
        args.tokenizer_model_path = os.path.join(local_model("Qwen/Qwen3-TTS-12Hz-1.7B-Base"), "speech_tokenizer")
